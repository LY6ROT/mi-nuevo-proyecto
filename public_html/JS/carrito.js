document.addEventListener('DOMContentLoaded', () => {
    ...
    // Base de datos de Planes de Membresía (Necesario para el Carrito)
    ...
    // Base de datos de Gimnasios (Para Grid y Detalle)
    const gymData = {
        'smartfit-norte': {
            id: 'smartfit-norte',
            name: 'SMARTFIT',
    ...
    function navigateTo(pageId) {
        ...
        if (targetPage) {
            ...
            // AJUSTE OBLIGATORIO: RENDERIZAR CARRITO COMPLETO AL NAVEGAR
            if (pageId === 'page-carrito') {
                renderAllCarts(); 
            }
    ...
    allCloseButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            e.stopPropagation(); // Evita que se propague al body/overlay
    ...
    function addToCart(itemId) {
        ...
        saveCart();
        // Asumiendo que openModal existe para abrir el sidebar al añadir
    ...
    function init() {
        // initCarousel(); // Asume que existe
        // renderGymCards(); // Asume que existe
        
        loadCart();
        // navigateTo('page-inicio'); // Asume que existe
    }
